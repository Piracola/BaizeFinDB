...
powershell -ExecutionPolicy Bypass -File clients/windows/first-trial.ps1 -StartDockerBackend -DeployCheckJsonOutput evidence/server-deploy-check.json -DeployCheckServerComposeContract -DeployCheckM5Smoke -DeployCheckBackupJsonOutput evidence/postgres-backup-check.json -SmokeCompactJsonOutput evidence/windows-client-smoke-compact.json
```
